    ...
    <div id="features" class="container mx-auto px-5">
        <section class="py-16">
            <div class="w-4/5 md:w-3/5 mx-auto">
                <h2 class="text-3xl md:text-4xl font-semibold font-theme-heading text-center">Программа курса</h2>
                <p class="text-theme-grayish-blue text-center mt-7 font-theme-content text-lg">Есть такие разделы</p>
            </div>
                    ...
                    <div v-show="isOpen === feature.id" class="grid gap-32 lg:grid-cols-2 items-center">
                        ...
                        <div>
                            ...
                            <div class="flex justify-center lg:justify-start mt-7">
                                <LinkButton btn-type="primary" :link="feature.details.link">Записаться на курс</LinkButton>
                            </div>
                        </div>
                    </div>
                </template>
