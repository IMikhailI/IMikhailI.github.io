<template>
    <div class="container mx-auto px-5 overflow-x-hidden lg:overflow-x-visible">
        <section class="grid grid-cols-none lg:grid-cols-2 pb-16 pt-8 items-center relative z-10">
            <div class="lg:w-5/6 order-2 lg:order-none">
               <h2 class="text-3xl md:text-4xl font-theme-heading font-medium text-center">Кто такой frontend-разработчик?</h2>
                <div class="mt-10 space-y-6">
                    <!-- FAQ элементы -->
                     <div class="text">Frontend-разработчик — это специалист, который занимается разработкой пользовательского интерфейса, то есть той части сайта или приложения, которую видят посетители страницы. Главная задача фронтенд разработчика — перевести готовый дизайн-макет в код так, чтобы все работало правильно.</div>
                </div>
            </div>
                  ...
                  <div class="wrap">
                     ...
                     <div class="body">
                        <pre class="pre">          <code>-&nbsp;</code>
                           <code>npm&nbsp;</code>
                           <code class="cmd" data-cmd="creat vue@latest"></code>
                        </pre>
                     </div>
                     </div>
                  </div>
...
.text {
    ...
    color: #000000;
    padding: 0 1rem;
    /* background-color: #d5d8ed89; */
    background: rgba(223, 231, 232, 0.52);
    border-radius: 18px;
    /* box-shadow: 0 8px 6px rgba(0, 0, 0, 0.1); */
    box-shadow: 0 10px 24px rgb(114, 130, 133);
    padding: 15px;
}
